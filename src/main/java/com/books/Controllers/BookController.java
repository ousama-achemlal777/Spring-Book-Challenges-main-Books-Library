...
public class BookController {
    ...
    @PutMapping("{id}")
    public void update(@PathVariable("id") int id, @RequestBody Book book)throws EntityNotFoundException{
        bookService.update(id , book);
    }

    // sorted books by price*
    @GetMapping("sort")
    public List<Book> getSortedByPrice(@RequestParam(value = "sort" , defaultValue = "false" ) String desc){
    ...
    @GetMapping("filter")
    public List<Book> getFilteredByPrice(@RequestParam(value = "min" ) int min,@RequestParam(value = "max" ) int max){
